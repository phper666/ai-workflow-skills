...
按 Phase 1 的载体选择初始化：
- **飞书多维表格**：建"待确认项"表，字段（类型参考：编号/问题/回答/回写位置=文本，优先级/待确认角色/状态/共识版本=单选，创建人/复核人=人员或文本，章节/规则编号=文本，创建时间=日期）：
  编号 / 问题 / 优先级 / 待确认角色 / 创建人 / 共识版本 / 章节 / 规则编号 / 状态（open/answered/closed）/ 回答 / 回写位置 / 复核人 / 创建时间
