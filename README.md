...
| `phper666-teamflow-story-to-contract` | BE（FE/QA 复核） | 契约生成/幂等更新/复核/澄清/子任务创建/交付核验（设计核验 + 契约核验双核验） | "为 DH-12 生成契约" |
...
★技术方案 ─●实现纪律 ─10 交付核验(三层) ─11 传播 ─12 沉淀
  [phper666-teamflow-tech-design]  [implement-        [phper666-teamflow-story-to-contract]   [change-     [phper666-teamflow-lesson-deposit]
   判级+工程基线]  discipline]       ①设计 ②契约 ③PRD     propagation]  + phper666-teamflow-consensus-scan
```
